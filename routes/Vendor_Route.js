...
//just started
// VendorRoute.get("/onlinestockreport", Vendor.onlineStockReport)
VendorRoute.get("/onlinestockreport",Vendor.authMiddleware, StockReport.onlineStockReport);
// not started
VendorRoute.get(
  "/offlinestockreport",
  Vendor.authMiddleware,
  StockReport.offlineStockReport
);

// for offline bill generations for vendor(offline shop) by kiran  //completed
VendorRoute.post(
  "/offlinebill",
  Vendor.authMiddleware,
  Vendor.offlineVendorBill
);

VendorRoute.get(
  "/productsearch",
  Vendor.authMiddleware,
  Vendor.searchSingleProduct
);
